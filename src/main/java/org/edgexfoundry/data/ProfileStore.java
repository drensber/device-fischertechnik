...
public class ProfileStore {
	...
	// profile
	// object key
	private Map<String, Map<String, FischertechObject>> objects = new HashMap<>();
	
	public Map<String, Map<String, FischertechObject>> getObjects() {
		return objects;
	}
	...
	public void addDevice(Device device) {
		...
		Map<String, FischertechObject> deviceObjects = new HashMap<>();
		for (DeviceObject object: device.getProfile().getDeviceResources()) {
			FischertechObject FischertechObject = new FischertechObject(object);
			
			PropertyValue value = object.getProperties().getValue();
			
			deviceObjects.put(object.getName(), FischertechObject);
